    ...
    public static String getPegaDBUrl() {
        ...
        switch (environment) {
            case "aqa":
                ...
                dbHostName = TestConfigHelper.get().getTestConfigItem("aqaHostName");
                break;
            case "qa":
                dbServiceName = TestConfigHelper.get().getTestConfigItem("qaDbServiceName");
                dbHostName = TestConfigHelper.get().getTestConfigItem("qaHostName");
                break;
            case "test":
                dbServiceName = TestConfigHelper.get().getTestConfigItem("testDBServiceName");
                dbHostName = TestConfigHelper.get().getTestConfigItem("testHostName");
                break;
            default:
